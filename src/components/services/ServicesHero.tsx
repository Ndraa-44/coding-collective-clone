    ...
    <section className="relative min-h-screen flex items-center pt-28 md:pt-36 overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0">
        <video 
          ...
          muted 
          playsInline 
          className="absolute inset-0 w-full h-full object-cover scale-110 md:scale-125 opacity-90 md:opacity-100"
        >
        ...
        <div className="absolute inset-x-0 top-0 h-48 bg-gradient-to-b from-black/30 via-black/10 to-transparent z-10 pointer-events-none" />
        {/* Smoother bottom fade to blend with the next section */}
        <div className="absolute inset-x-0 bottom-0 h-48 md:h-72 bg-gradient-to-t from-black via-black/40 to-transparent z-10 pointer-events-none"></div>
      </div>
